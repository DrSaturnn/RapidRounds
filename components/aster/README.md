...
- `AsterAssets.ts`: approved production asset registry.
...
The runtime avatar renders from `public/aster/production/neutral.png`.
...
matching approved production PNG exists.
